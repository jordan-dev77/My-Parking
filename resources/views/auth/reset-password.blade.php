	...
	<section class="ftco-section">
        ...
        <input type="hidden" name="token" value="{{ $request->route('token') }}">
		      		...
		      		<div class="form-group">
		      			<input type="email"name="email" class="form-control  @error('email') is-invalid @enderror" value="{{old(', $request->email')}}" placeholder="email" autocomplete="username">
                          @error('email')
                ...
                <div class="form-group">
	              <input id="password_confirmation" type="password" name="password_confirmation" class="form-control @error('password_confirmation') is-invalid @enderror" value="{{old('password_confirmation')}}" placeholder="password confirmation" >
	              <!-- <span toggle="#password-field" class="fa fa-fw fa-eye field-icon toggle-password"></span> -->
